...
class Tea {
    ...
    static public function encrypt($v, $k) {
        $vl = strlen($v);
    ...
    static private function _xor($a, $b){
        $a = self::_str2long($a);
        $a1 = $a[0];
        $a2 = $a[1];
        $b = self::_str2long($b);
    ...
    static public function block_encrypt($v, $k) {
        $s=0;
        $delta=0x9e3779b9;
        $n = 16;
    ...
    static public function block_decrypt($v, $k) {
        $delta=0x9e3779b9;
        $s = ($delta << 4) & self::$op;
        #$s=0xC6EF3720;
        $n=16;
    ...
    static private function _str2long($data) {
        $n = strlen($data);
        $tmp = unpack('N*', $data);
        $data_long = array();
        $j = 0;
    ...
    static private function _long2str($l){
        return pack('N', $l);
    }
